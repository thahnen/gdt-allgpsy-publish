...
<body>
    ...
    <div class="div--wrapper">
        ...
        <p>Lehrstuhl Allgemeine Psychologie: Kognition</p>
        <p>Forsthausweg 2</p>
        <p>Gebäude LE</p>
        <p>47057 Duisburg</p>
        <br>
        <h2>Programmierung erfolgte durch:</h2>
        <p><a href="http://thahnen.github.io">Tobias Hahnen</a></p>
        <p>Stand: 03.04.2018</p>
    </div>
</body>
